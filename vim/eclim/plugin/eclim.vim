...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/dhaivat/workspace/installs/eclipse-indigo/plugins/org.eclim_1.7.1'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/dhaivat/workspace/installs/eclipse-indigo'
  if has('win32unix')
