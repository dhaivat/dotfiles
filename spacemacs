...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Sauce Code Powerline Regularddd"
                               :size 13
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
